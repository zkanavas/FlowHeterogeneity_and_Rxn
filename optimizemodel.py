...
def calculate_rxn(weights,*inputs,returnr2=False):
    ...
    # print(r2)
    aic = len(np.nonzero(weights)[0]) - r2
    if returnr2 == False: return r2*-1
    elif returnr2 == True: 
        print(len(np.nonzero(weights)[0])) 
        return r2
...
# w = [ 0,  0., -1,  0., 0,
#         0.13736543,  0.24721578, -0.10711941, -0.49422232,  0.15398939,
#         0.49332556,  0.58292997,  0.60595092,  0.44121158, -0.64849797,
#         1]
# r2 = calculate_rxn(w,*inputs,returnr2=True)
# print('r2 = ', r2)
